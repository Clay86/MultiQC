...
class DragenMappingMetrics(BaseMultiqcModule):
...
MAPPING_METRICS = [
    ...
    Metric("Q30 bases", "Q30", "#", "#", "bases", "Number of raw bases with BQ >= 30, {}"),
    Metric("% Q30 bases", "Q30 pct", "#", "#", "%", "Percentage of raw bases with BQ >= 30, {}"),
